...
function LedControl() {
    console.log("Led Control button clicked from Unity");
    DotNet.invokeMethodAsync('MudBlazorWebApp240916.Client', 'ShowBlazorDialog', "MemoList");
}

function WaterControl() {
    console.log("Water Control button clicked from Unity");
    DotNet.invokeMethodAsync('MudBlazorWebApp240916.Client', 'ShowBlazorDialog', "MemoList");
}

function AirControl() {
    console.log("Air Control button clicked from Unity");
    DotNet.invokeMethodAsync('MudBlazorWebApp240916.Client', 'ShowBlazorDialog', "MemoList");
}

function MemoList() {
    console.log("Memo List button clicked from Unity");
    DotNet.invokeMethodAsync('MudBlazorWebApp240916.Client', 'ShowBlazorDialog', "MemoList");
}
